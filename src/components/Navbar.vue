<template>
    <div class="pb-12 mb-6" style="background:#0D0206">
            ...
            <ul v-if="openNav === true" class="text-white lg:flex text-lg ml-3 pt-2 mt-12  pl-2 pb-4 font-semibold">
                    ...
                    <li v-if="storeEmail" class="my-1 hover:text-pink-500 font-bold">{{storeEmail}}</li>
                    <li v-else  class="my-1 hover:text-pink-500 font-bold"><router-link to="/register">Signup/</router-link><router-link to="/login">Login</router-link></li>
...
const storeEmail = computed(() => store.state.auth.email)
