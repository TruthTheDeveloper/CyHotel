<template>
    <section class="">
        ...
        <div class="flex justify-center">
            ...
            <swiper-slide>
                <rooms-card 
                roomImage="../../assets/images/room3.jpg" roomType="Classic Room" 
                roomDescription="Double bed 2 window mountain view" roomPrice="$80/night"/>
            </swiper-slide>
            <swiper-slide>
                <rooms-card 
                roomImage="../../assets/images/room3.jpg" roomType="Double Room" 
                roomDescription="Semi double bed 3 widows mountai view" roomPrice="$50/night"/>
            </swiper-slide>
            <swiper-slide>
                <rooms-card 
                roomImage="../../assets/images/room3.jpg" roomType="Flat Room" 
                roomDescription="Sami double bed 1 guest room 3 windows" roomPrice="$150/night"/>
            </swiper-slide>
            <swiper-slide>
                <rooms-card 
                roomImage="../../assets/images/room3.jpg" roomType="Duplex Room" 
